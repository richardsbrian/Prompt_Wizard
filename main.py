...
sprite = AnimatedSprite("png_files\\wizard_things\\walking.png", 4, "png_files\\wizard_things\\idle.png", 4, "png_files\\wizard_things\\freeze.png" ,10, scale_factor=2, screen_width=width, screen_height=height)
...
def handle_mouse_button_up_event(event):
    ...
    if dragging:
        ...
        if not display_screenshot_with_input('png_files\\screenshots\\box_screenshot.png'):
            running = False
